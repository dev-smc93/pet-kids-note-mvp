...
| POST   | `/api/reports/[id]/remind`  | 재알림 (표시만, 2차: 푸시 알람 연동 예정)   | ADMIN  |
...
| 재알림 | 관리자: 보호자 미읽음 시 "재알림" 버튼 표시 (2차: 푸시 알람 연동) |
...
| 푸시 알람 | 알림장 등록, 댓글 등록 시 발송 |
| 재알림 푸시 | 재알림 버튼 클릭 시 보호자에게 푸시 알람 발송 (현재: 버튼/메시지만) |
